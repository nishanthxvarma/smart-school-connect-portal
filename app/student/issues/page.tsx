    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-slate-500">Report broken benches, damaged facilities, or other school property concerns</p>
        </div>
        <button 
      ...
      {loading ? (
        ...
        <div className="bg-slate-50 border border-dashed border-slate-200 rounded-2xl p-12 text-center text-slate-400 text-sm">
          No issues reported by you. Click &quot;Report Issue&quot; if you see any infrastructure problems.
        </div>
      ) : (
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              <div>
                ...
                <input
                  type="text"
                  required
                  placeholder="e.g. Broken fan in class 10-A"
                  value={title}
